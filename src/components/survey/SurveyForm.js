...
export function SurveyForm() {
    ...
    return (
        <div>
            <FormControl style={{ width: "100%", my: 3 }} component="form" onSubmit={handleSendButton}>
                ...
                <div style={{ margin: '25px', display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
                    ...
                    <Box >
                        ...
                        <RadioGroup
                            ...
                            style={{ width: "100%" }}
                        >
                            <FormControlLabel value="tak" name="proffesionalActivity" control={<Radio required={true} />} label="Tak" />
                            <FormControlLabel value="nie" name="proffesionalActivity" control={<Radio required={true} />} label="Nie" />
                        </RadioGroup>
                    </Box>
                </div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
                    ...
                    <Box sx={{ m: 1, mx: 5 }}>
                        ...
                        <RadioGroup
                            ...
                            onChange={handleChange}
                        >
                            <FormControlLabel value="tak" control={<Radio required={true} />} label="Tak" disabled={proffesionalActivity} />
                            <FormControlLabel value="nie" control={<Radio required={true} />} label="Nie" disabled={proffesionalActivity} />
                        </RadioGroup>
                    </Box>
                    <Box sx={{ m: 1, mx: 5 }}>
                        ...
                        >
                            <FormControlLabel value="tak" control={<Radio required={true} />} label="Tak" disabled={proffesionalActivity} />
                            <FormControlLabel value="nie" control={<Radio required={true} />} label="Nie" disabled={proffesionalActivity} />
                            <FormControlLabel value="trudno_powiedziec" control={<Radio required={true} />} label="Trudno stwierdzić" disabled={proffesionalActivity} />
                        </RadioGroup>
                    </Box>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
                    <Box sx={{ mb: 5, mx: 5 }}>
                        <Button type="submit" variant="contained" endIcon={<SendIcon />} disabled={buttonDisable}>
