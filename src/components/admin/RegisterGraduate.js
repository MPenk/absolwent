...
export function RegisterGraduate() {
  ...
  return (
    <>
    <Box sx={{ minWidth: 120 }}>
      <FormControl style={{ width: "100%", my: 3 }}  component="form" onSubmit={handleSubmit(onSubmit)}>
      ...
      <TextField
        ...
        <TextField
          ...
          {...register("graduationYear", {
            ...
            max: { value: new Date().getFullYear(), message: "Maksymalny rok to "+new Date().getFullYear() },
            onChange: () => handleChangeError(),
          })}
        />
        <TextField
          ...
          <MenuItem value="Zarządzania i nauk o jakości">Zarządzania i nauk o jakości</MenuItem>
